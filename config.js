...
global.sudo = process.env.SUDO || "‪8297735823";
global.owner = process.env.OWNER_NUMBER || "8297735823";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "`BRAND PRODUCT OF ☞BOTIP-Ash☜`",
  author: process.env.PACK_AUTHER || "BOTIP-Ash",
  packname: process.env.PACK_NAME || "BOTIP-Ash",
  botname: process.env.BOT_NAME || "BOTIP-Ash𖤐",
  ownername: process.env.OWNER_NAME || "☞BOTIP-Ash☜",
